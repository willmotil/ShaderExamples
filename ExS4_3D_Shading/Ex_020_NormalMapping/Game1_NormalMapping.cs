    ...
    public class Game1_NormalMapping : Game
    {
        ...
        public void DrawSpriteBatches(GameTime gameTime)
        {
            ...
            string msg =
                ...
                $" \n  " +
                $" \n In this example we yet again change our mesh this time to create tangent vectors.." +
                $" \n A tangent vector has a right angle to the normal typically following the uv of the mesh." +
                $" \n On the shader itself we will generate a bitangent to build a full orientation matrix." +
                $" \n Our shader will also take a normal map to offset the mesh normals." +
                $" \n From this point we can apply lighting to the altered normal." +
                $" \n In fact if we wished we could use the normal map in this fashion to do vertex displacement on the shader." +
                $" \n Since however we have already demonstrated that in the last example we wont do so here." +
                $" \n  " +
