...
{
    public class Game1_Refraction : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            Content.RootDirectory = @"Content";
            effect = Content.Load<Effect>("RefractionEffect");
            ...
            effect.CurrentTechnique = effect.Techniques["RefractionSimple"];
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            refractionRange = EnsureInRange(refractionRange, 2f);
