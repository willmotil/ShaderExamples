...
namespace ShaderExamples
{
    public class Game1_EnviromentalMapping : Game
    {
        ...
        public Game1_EnviromentalMapping()
        {
            ...
            Window.Title = " ex Enviremental Mapping Cubemaps Skyboxes ";
            IsMouseVisible = true;
        ...
        public void LoadAndSetupInitialEnvEffect()
        {
            ...
            EnviromentalMapEffectClass.Technique_Render_PhongWithNormMapEnviromentalLight();
            ...
            EnviromentalMapEffectClass.AmbientStrength = 0.4f;
            EnviromentalMapEffectClass.DiffuseStrength = .30f;
            EnviromentalMapEffectClass.SpecularStrength = .30f;
