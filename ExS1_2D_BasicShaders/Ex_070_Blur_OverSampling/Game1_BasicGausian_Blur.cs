...
{
    public class Game1_BasicGausian_Blur : Game
    {
        ...
        public Game1_BasicGausian_Blur()
        {
            graphics = new GraphicsDeviceManager(this);
            graphics.GraphicsProfile = GraphicsProfile.HiDef;
            Content.RootDirectory = "Content";
            Window.AllowUserResizing = true;
            Window.Title = " ex Blur Effect   GausianBlurEffect.";
            IsMouseVisible = true;
        }
        ...
        protected override void LoadContent()
        {
            ...
            texture = Content.Load<Texture2D>("BloomTestImage");
